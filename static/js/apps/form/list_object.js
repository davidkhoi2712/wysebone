 ...
 */
function ListObjectField(option) {
    var self = this;
    this.parent = option.parent;
    this.id = 'listObject-' + Date.now();
    ...
    // field_name
    this.name = gettext('List Object');


    this.attributeModal = $('#attributeModal');

    this._item = $('<div class="wb-drop-item" id="' + self.id + '" style="width: ' + self.width + 'px;height: ' + option.height + 'px;"></div>');
    ...
    this.init = function() {
        ...
        let box = $('<div class="list_object_field rounded bg-white border d-flex justify-content-center align-items-center"/>');
    ...
    this.settings = function() {
        self.attributeModal.find('.modal-title').html('<img src="' + base_url + '/static/images/icon/' + self.itemtype.icon + '"> <span>' + interpolate(gettext('%s Settings'), [gettext('List Object')]) + '</span>');
