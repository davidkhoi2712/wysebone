 ...
 */
function IframeField(option) {
    var self = this;
    this.parent = option.parent;
    this.id = 'iframe-' + Date.now();
    ...
    this.settings = function() {
        self.attributeModal.find('.modal-title').html('<img src="' + base_url + '/static/images/icon/' + self.itemtype.icon + '"> <span>' + interpolate(gettext('%s Settings'), [self.name]) + '</span>');
